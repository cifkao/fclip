...
public:
    ...
    : ::DBus::InterfaceAdaptor("com.fclip.Fclip")
    {
        ...
        register_method(Fclip_adaptor, ListFiles, _ListFiles_stub);
    ...
    ::DBus::IntrospectedInterface *const introspect() const 
    {
        ...
        static ::DBus::IntrospectedArgument ListFiles_args[] = 
        {
            { "directory", "s", true },
            { "absolute", "b", true },
            { "files", "as", false },
...
private:
    ...
    ::DBus::Message _ListFiles_stub(const ::DBus::CallMessage &call)
    {
        ::DBus::MessageIter ri = call.reader();
        ...
        bool argout3;
        ListFiles(argin1, argin2, argout1, argout2, argout3);
        ::DBus::ReturnMessage reply(call);
        ::DBus::MessageIter wi = reply.writer();
        wi << argout1;
        wi << argout2;
